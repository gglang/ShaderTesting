Shader "Sprites/SFSoftShadowAlphaBlendedPremultiply" {
// This shader is to be used on transparent objects in the scene; they will be rendered last and allow things to render behind them layered properly.
// ***WARNING*** Do not apply this shader to meshes that define several seperate objects; this will result in improper layering in the renders

	Properties {
		_MainTex ("Base (RGB)", 2D) = "white" {}
		_Tint ("Tint and Transparency", Color) = (1.0, 1.0, 1.0, 1.0)
		_SoftHardMix ("Unshadowed/Shadowed Mix", Range(0.0, 1.0)) = 0.7
		_AmbientOnlyMix ("Lit/Ambient Mix", Range(0.0, 1.0)) = 0.3
...
//			Blend One OneMinusSrcAlpha // Hides seams between things better sometimes, since top most thing is more prominent
			Cull Off
			Lighting Off
			ZWrite Off
			Ztest Lequal
