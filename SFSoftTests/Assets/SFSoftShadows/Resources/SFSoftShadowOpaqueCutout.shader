Shader "Sprites/SFSoftShadowOpaqueCutout" {
	...
	SubShader {
		...
		Pass {
			Blend Off
			// Blend One OneMinusSrcAlpha // This could be used if you want to not use ARGB1555 and have a background always rendered... not recommended
			Cull Off
			Lighting Off
			ZWrite On
			Ztest Lequal
